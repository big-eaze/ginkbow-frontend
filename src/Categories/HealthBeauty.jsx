...
function HealthBeauty() {
  ...
  async function fetchHBProducts() {
    try {
      ...
      setHealthBeauty(
        data.filter((item) => item.type === "Health and Beauty")
      );
    } catch (err) {
      console.error("Error fetching Health & Beauty:", err.message);
    }
  }
  ...
  // Trending Health & Beauty items (top 5 by rating)
  const trending = healthBeauty
    .slice()
    .sort((a, b) => b.rating.star - a.rating.star)
    .slice(0, 5);

  // Featured Health & Beauty collections
  const featuredCollections = [
    {
      title: "Skincare Essentials",
      image: "skincare.jpg",
      route: "/health-beauty?collection=skincare",
    },
    {
      title: "Supplements & Vitamins",
      image: "supplements.jpg",
      route: "/health-beauty?collection=supplements",
    },
    {
      title: "Wellness & Beauty",
      image: "wellness.jpg",
      route: "/health-beauty?collection=wellness",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Banner */}
      <div className="relative h-60 sm:h-80 lg:h-96 bg-gradient-to-r from-green-400 via-emerald-500 to-teal-600 flex items-center justify-center rounded-b-3xl shadow-xl mb-8">
        <div className="text-center px-4">
          ...
          <p className="text-white/90 mt-2 text-sm sm:text-base md:text-lg max-w-xl mx-auto">
            Explore top-rated health products, skincare essentials, and beauty
            must-haves curated for your wellness journey.
          </p>
        </div>
      </div>
        ...
        {trending.length > 0 && (
          <section>
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                to="/health-beauty?sort=trending"
