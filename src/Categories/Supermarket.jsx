...
function Supermarket() {
  ...
  async function fetchSMProducts() {
    try {
      ...
      setSupermarket(data.filter((item) => item.type === "Supermarket"));
    } catch (err) {
      console.error("Error fetching supermarket products:", err.message);
    }
  }
  ...
  // Trending Supermarket Items (top 5 by rating)
  const trending = supermarket
    .slice()
  ...
  const featuredCollections = [
    {
      ...
      image: "daily-essentials.jpg",
      route: "/supermarket?collection=daily-essentials",
    },
    {
      title: "Snacks & Beverages",
      image: "snacks-beverages.jpg",
      route: "/supermarket?collection=snacks",
    },
    {
      title: "Organic & Healthy",
      image: "organic-healthy.jpg",
      route: "/supermarket?collection=organic",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Banner */}
      <div className="relative h-60 sm:h-80 lg:h-96 bg-gradient-to-r from-green-500 via-lime-500 to-emerald-500 flex items-center justify-center rounded-b-3xl shadow-xl mb-8">
        <div className="text-center px-4">
          ...
          <p className="text-white/90 mt-2 text-sm sm:text-base md:text-lg max-w-xl mx-auto">
            Stock up on your everyday essentials, snacks, beverages, and organic products.
          </p>
        </div>
      </div>
