...
function HomeOffice() {
  ...
  // Fetch Home & Office products
  async function fetchHOProducts() {
    try {
      ...
      setHomeOffice(
        data.filter((item) => item.type === "Home and Office")
      );
    } catch (err) {
      console.error("Error fetching Home & Office:", err.message);
    }
  }
  ...
  // Trending Home & Office items (top 5 by rating)
  const trending = homeOffice
    .slice()
  ...
  const featuredCollections = [
    {
      ...
      image: "home-essential.jpg",
      route: "/home-office?collection=home-essentials",
    },
    {
      title: "Office Supplies",
      image: "office-supplies.jpg",
      route: "/home-office?collection=office-supplies",
    },
    {
      title: "Furniture & Decor",
      image: "furniture-decor.jpg",
      route: "/home-office?collection=furniture",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Banner */}
      <div className="relative h-60 sm:h-80 lg:h-96 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center rounded-b-3xl shadow-xl mb-8">
        <div className="text-center px-4">
          ...
          <p className="text-white/90 mt-2 text-sm sm:text-base md:text-lg max-w-xl mx-auto">
            Find quality furniture, office essentials, and decor to upgrade your home and workspace.
          </p>
        </div>
      </div>
