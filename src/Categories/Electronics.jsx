...
function Electronics() {
  ...
  async function fetchElectronicProducts() {
    try {
      ...
      setElectronics(data.filter((item) => item.type === "Electronics"));
    } catch (err) {
      console.error("Error fetching electronics:", err.message);
    }
  }
  ...
  // Helper: trending items (top 5 by rating)
  const trending = electronics
    .slice()
    .sort((a, b) => b.rating.star - a.rating.star)
    .slice(0, 5);

  // Helper: featured collections (grouped categories or curated picks)
  const featuredCollections = [
    {
      title: "Smartphone Bundles",
      image: "phone.jpg",
      route: "/electronics?collection=smartphones",
    },
    {
      title: "Work-from-home Essentials",
      image: "home-essentials.jpg",
      route: "/electronics?collection=wfh",
    },
    {
      title: "Gaming Gear",
      image: "gaming-gear.jpg",
      route: "/electronics?collection=gaming",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-60 sm:h-80 lg:h-96 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 flex items-center justify-center rounded-b-3xl shadow-xl mb-8">
        <div className="text-center px-4">
          ...
          <p className="text-white/90 mt-2 text-sm sm:text-base md:text-lg max-w-xl mx-auto">
            Explore the latest gadgets, top-rated devices, and exclusive deals
